...
<body class="hold-transition sidebar-mini layout-fixed">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url(''); ?>/template/back/./index.html" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v1</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url(''); ?>/template/back/./index2.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v2</p>
                                    </a>
                                </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="<?= base_url(''); ?>/template/back/dist/img/user1-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="<?= base_url(''); ?>/template/back/dist/img/user3-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user1-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user7-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user3-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user5-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user6-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="<?= base_url(''); ?>/template/back/dist/img/user8-128x128.jpg">
    ...
    <!-- jQuery -->
    <script src="<?= base_url(''); ?>/template/back/plugins/jquery/jquery.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
